	...
	<div class="text-lg font-[300] leading-relaxed text-textPrimary flex flex-col gap-y-3 font-space">
		<p>
			...
			<a
				...
				target="_blank"
				class="text-textAccent transition duration-200 hover:underline cursor-laptop"
			>
				Computer Science
			</a>
			student from Nigeria. Building things that run on computers is not only my area of study but also
			my <span class="text-textAccent">biggest passion.</span> I love diving into various tools,
			<a
